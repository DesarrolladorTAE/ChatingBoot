...
export interface ContactTypes {
  id: string | number;
  firstName: string;     // <- mapea de 'first_name' del backend
  lastName: string | null;   // <- mapea de 'last_name' del backend (puede ser null)
  profileImage?: string | null; // <- mapea de 'profile_image' (puede ser null)
  email: string | null;  // <- mapea de 'email' del backend (puede ser null)
  phone: string;         // <- mapea de 'phone' del backend
  ownerId: string | number; // <- mapea de 'owner_id'
  createdAt?: string;    // <- mapea de 'created_at'
  updatedAt?: string;    // <- mapea de 'updated_at'
  lastSeenAt?: string | null; // <- mapea de 'last_seen_at' (puede ser null)

  // Extras (opcional, si después agregas campos)
  about?: string;
